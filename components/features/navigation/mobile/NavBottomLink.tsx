...
const NavBottomLink: FC<NavLinkProps> = ({ href, icon: Icon, icon_fill: IconFill, label }) => {
  ...
  return (
    <Link href={href} className={`flex flex-1 flex-col items-center justify-center opacity-80`}>
      <div
