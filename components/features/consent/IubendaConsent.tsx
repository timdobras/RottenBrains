...
const IubendaScripts = () => {
  return (
    <>
      ...
      <Script src="https://cs.iubenda.com/autoblocking/3926952.js" strategy="afterInteractive" />
      <Script src="//cdn.iubenda.com/cs/tcf/stub-v2.js" strategy="afterInteractive" />
      <Script src="//cdn.iubenda.com/cs/tcf/safe-tcf-v2.js" strategy="afterInteractive" />
